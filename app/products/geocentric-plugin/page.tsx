            ...
            <div className="relative max-w-6xl mx-auto pt-4 sm:pt-6">
              ...
              <div className="relative group">
                ...
                <div className={`relative rounded-xl sm:rounded-2xl overflow-hidden shadow-xl border transition-all duration-500 hover:shadow-2xl ${
                  ...
                  <img
                    ...
                    alt="Geocentric Plugin demonstration showing automatic location data embedding workflow"
              ...
              <div className="grid sm:grid-cols-3 gap-6 mt-12 sm:mt-16 max-w-4xl mx-auto">
                <div className="text-center">
                  ...
                  <h4 className={`font-semibold mb-1 ${isDarkMode ? 'text-white' : 'text-black'}`}>Instant Setup</h4>
                ...
                <div className="text-center">
                  ...
                  <h4 className={`font-semibold mb-1 ${isDarkMode ? 'text-white' : 'text-black'}`}>Google Data</h4>
                ...
                <div className="text-center">
                  ...
                  <h4 className={`font-semibold mb-1 ${isDarkMode ? 'text-white' : 'text-black'}`}>SEO Boost</h4>
